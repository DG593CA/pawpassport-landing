...
const reviews = [
  { name: "Sarah Jenkins", pet: "Dog Owner", state: "California", stars: 5, text: "I was so stressed about moving to a new apartment that didn't allow large dogs. PawPassport was incredibly fast, and the therapist was so understanding. My landlord accepted the letter immediately!" },
  ...
  { name: "Elena R.", pet: "Dog Owner", state: "New York", stars: 5, text: "After a terrible experience with a scam site, I was hesitant. PawPassport is the real deal. Legitimate doctors, professional service, and a beautifully formatted letter that my strict HOA accepted without question." },
  ...
  { name: "Tom & Laura K.", pet: "Cat Owners", state: "Washington", stars: 5, text: "We have two cats and were moving to a strict no-pets building. PawPassport helped us get letters for both pets. The landlord asked zero follow-up questions. Absolute lifesavers." },
    ...
    <Layout>
      ...
      <section className="pt-16 pb-12 px-4 text-center bg-brand-cream/30 border-b border-border">
        <div className="container mx-auto max-w-3xl">
          ...
          <motion.p initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }} className="text-lg text-foreground/70">
            Thousands of families have used PawPassport to keep their pets home. Here's what they have to say.
          </motion.p>
      ...
      <section className="py-20 px-4 bg-brand-green text-white text-center">
        <div className="container mx-auto max-w-2xl">
          ...
          <p className="text-white/90 text-lg mb-8">Join over 50,000 pet owners who sleep easier with PawPassport.</p>
